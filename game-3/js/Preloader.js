...
GameStates.makePreloader = function( game ) {
    ...
    return {
        ...
        preload: function () {
            ...
            game.load.audio('ratDeath', ['assets/ratDeath.flac'])
            game.load.audio('ladyHit', ['assets/ladyHit.mp3'])
            game.load.audio('ladyDeath', ['assets/ladyDeath.wav'])
            game.load.audio('catDeath', ['assets/catDeath.ogg'])
            
            game.load.image('background', 'assets/background.png')
            game.load.image('winBackground', 'assets/winBackground.png')
            game.load.image('loseBackground', 'assets/loseBackground.png')
            game.load.image('startButton', 'assets/start.png')
            game.load.image('rat', 'assets/rat.png');
            game.load.image('cat', 'assets/cat.png');
            game.load.image('lady', 'assets/lady.png');
